...
• Keep plans and task lists up to date throughout your work. Task list operations (propose_task_list and update_task_list) can always be combined with any other tool calls, allowing you to track progress while performing other operations."#;
